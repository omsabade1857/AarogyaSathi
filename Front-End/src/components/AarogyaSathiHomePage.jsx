...
export function AarogyaSathiHomePage() {
        ...
        <>
                ...
                <div className="bg-light text-dark px-4 py-0 text-center">
                    <div className="py-5">
                        <div className="row">
                            ...
                            <div className="col-5">
                                <h2 className="display-5 fw-medium text-warning">
                                Health is Wealth!
                                </h2>
                            </div>
                            <div className="col-3" />
            ...
            <Container className="card-container" >
                <Row className="justify-content-around">
                    <Col lg={4}>
                        <Card className="card hover-container" style={{border:'1px solid black',marginTop:'3%' ,boxShadow: '0 0 20px rgba(0, 0, 0, 0.5)'}}>
                    ...
                    <Col lg={4}>
                        <Card className="card hover-container" style={{border:'1px solid black',marginTop:'3%' ,boxShadow: '0 0 20px rgba(0, 0, 0, 0.5)'}}>
                            <Card.Img variant="top" src="https://i.pngimg.me/thumb/f/720/comvecteezy287717.jpg" className='mt-4' height={320} />
                            <Card.Body className='text-center'>
